...
- [node](https://nodejs.org/en/download/) or [yarn](https://classic.yarnpkg.com/en/docs/install/#windows-stable) installed on device
- [VS Code](https://code.visualstudio.com/Download) or any other IDE of your choice
